...
`Security` tab on the
[Phos repository](https://github.com/parmenides-xyz/phos/security).
...
The scope of this security policy applies to the code in the
[Phos repository](https://github.com/parmenides-xyz/phos) and any related
infrastructure maintained by the Phos project.
...
is consistent with this policy, please submit a report through the Official
Communication Channel before going any further.
